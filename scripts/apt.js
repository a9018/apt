...
var Titles = new initArray("شـارژ", "آسانسور", "پمپ آب", "آنتن مرکزی", "5", "6", "7", "8", "---", "آب", "برق", "آسانسور", "نظافت", "پمپ آب", "متفرقه","درب پارکینگ","روشنایی","اتصالات آب","آنتن مرکزی","کودوخاک");
 ...
 //   alert(shrDate);
    switch (true) {
        ...
        case shrDate == 420933: // پمپ آب 140311  
            result = 1150000;
            break;
        case shrDate == 561636: // آنتن مرکزی 140409  
            result = 120000;
            break;
        case shrDate < 140407:
            result = 250000;
